...
csv_file = os.path.join(script_directory, 'CSV Files', 'Sony Playstation 2.csv')

# Directory to save the fake ROMs (going up one directory and then to 'Games/Sony Playstation 2')
rom_directory = os.path.join(script_directory, '..', 'Games', 'Sony Playstation 2')
